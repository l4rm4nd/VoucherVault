...
| `SESSION_EXPIRE_AT_BROWSER_CLOSE`| Define the maximum cookie age in minutes.                                                                       | `30`                    | Optional            |
| `SESSION_COOKIE_AGE`             | Set to `False` if you want to keep sessions valid after browser close                                           | `False`                    | Optional            |
